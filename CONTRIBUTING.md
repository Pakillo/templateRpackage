...
writing R code. We recommend that you install
[air](https://github.com/posit-dev/air) to automatically format your R
code.

The project `templateRpackage` uses the `lower_snake_case` for naming
...
For instance, for a contribution on the README:
`doc: add reference in README`
...
2.  [Clone](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
    ...
    of your fork). Alternatively, open RStudio/Positron IDE and create a
...
Do not forget to replace `Vignette Title` (twice) by the title of your
new vignette.
